...
public class BattleField {
	...
	//por quest�es de configuracao da engine cada botao tem que ser configurado manualmente sem o uso de loops
	...
	//apaga a imagem do rob� do jogador se seu HP � zero
	...
	//apaga a imagem do rob� do inimigo se seu HP � zero
	...
	//atualiza as barras de HP de ambos os rob�s
